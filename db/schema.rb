...
ActiveRecord::Schema[8.0].define(version: 2025_04_01_100344) do
  ...
  create_table "check_invoices", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "check_id", null: false
    t.bigint "invoice_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["check_id", "invoice_id"], name: "index_check_invoices_on_check_id_and_invoice_id", unique: true
